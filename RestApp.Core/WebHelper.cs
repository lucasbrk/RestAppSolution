...
namespace RestApp.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool useSsl)
        {
            ...
            {
                string storeHost = GetSiteHost(useSsl);
        ...
        public virtual string GetSiteHost(bool useSsl)
        {
            ...
            else
            {
                ...
                var siteSettings = EngineContext.Current.Resolve<RestAppSiteSettings>();
                result = siteSettings.Url;
            }
            if (!result.EndsWith("/"))
                result += "/";
            if (useSsl)
            ...
            else
            {
                if (SslEnabled())
                {
                    ...
                    if (!String.IsNullOrEmpty(sharedSslUrl))
                    {
                         ...
                         * but we cannot reference RestApp.BusinessLogic.dll assembly.
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new ApException("RestApp needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        private bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into apsaludCommerce, 
                ...
                //The issue is described here: http://www.apsaludcommerce.com/boards/t/10969/apsalud-20-plugin.aspx?p=4#51318
        ...
        public virtual bool IsSearchEngine(HttpContextBase context)
        {
            ...
            //more info: http://www.apsaludcommerce.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            if (context == null)
                return false;
