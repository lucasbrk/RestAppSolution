...
{
    /// <summary>
    /// A class that finds types needed by RestApp by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether RestApp should iterate assemblies in the app domain when loading RestApp types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that RestApp assemblies arn't investigated (e.g. by not including something like "^RestApp|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the RestApp factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into RestApp.</returns>
