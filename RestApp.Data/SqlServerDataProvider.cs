...
using RestApp.Data.Initializers;
...
namespace RestApp.Services
{
    public class SqlServerDataProvider : BaseEfDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have RestAppCommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<ApObjectContext>(tablesToValidate, customCommands.ToArray());
