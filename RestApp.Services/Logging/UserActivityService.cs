...
namespace RestApp.Services.Logging
{
    /// <summary>
    ...
    {
        #region Constants
        private const string ACTIVITYTYPE_ALL_KEY = "RestApp.activitytype.all";
        private const string ACTIVITYTYPE_BY_ID_KEY = "RestApp.activitytype.id-{0}";
        private const string ACTIVITYTYPE_PATTERN_KEY = "RestApp.activitytype.";
        #endregion
            ...
            string comment, params object[] commentParams)
        {
            ...
            activity.User = _workContext.CurrentUser;
