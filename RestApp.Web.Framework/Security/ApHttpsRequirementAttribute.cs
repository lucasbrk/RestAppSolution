...
namespace RestApp.Web.Framework.Security
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = false)]
    public class ApHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public ApHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new ApException("Not supported SslProtected parameter");
            }
        }
